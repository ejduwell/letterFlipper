...
- Frameworks for creating and running tasks are highly generalized and can both create and impliment a wide range of potential different tasks with minimal coding.
    - Q: How does **letterFlipper** achieve this? A: 'Parameter Descriptor Files'
      ...
      - These allow users to define all relevant aspects of task.
      - The "image flipper" for presenting stimuli and collecting data was intentionally written in highly generalized manner and can run any task generated by the "letter image/task generation" workflow without updating or re-coding.
...
- Task image parameter maniplations currently supported:
      - Set of letters presented
      - Set of different locations in which letters can appear
      - Set of possible text sizes
      - Set of possible text colors/luminance in the form of rgb vectors
      - Set of possible rotation angles applied to letters. 
